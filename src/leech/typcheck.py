...
class TypCheck:
    ...
    def check_while_expr(self, while_ast: ast.WhileExpr, e: ir_env.Env) -> typs.Typ:
    ...
    def check_call_expr(self, call_ast: ast.CallExpr, e: ir_env.Env) -> typs.Typ:
    ...
    def check_logic_bin_op_expr(self, op_ast: ast.BinOpExpr, e: ir_env.Env) -> typs.Typ:
    ...
    def check_var_expr(self, var_ast: ast.VarExpr, e: ir_env.Env) -> typs.Typ:
    ...
    def check_array_access_expr(self, aa_expr: ast.ArrayAccessExpr, e: ir_env.Env) -> typs.Typ:
        ...
        index_typ = self.check_expr(aa_expr.index, e, typs.USIZE)
    ...
    def check_struct_expr(self, struct_expr: ast.StructExpr, e: ir_env.Env) -> typs.Typ:
    ...
    def check_struct_access_expr(self, sa_expr: ast.StructAccessExpr, e: ir_env.Env) -> typs.Typ:
    ...
    def check_deref_expr(self, d_expr: ast.DerefExpr, e: ir_env.Env) -> typs.Typ:
    ...
    def check_place(self, expr_ast: ast.Expr, e: ir_env.Env) -> typs.PtrTyp:
    ...
    def check_stmt(self, stmt_ast: ast.Stmt, e: ir_env.Env) -> bool:
        ...
        match stmt_ast:
            case ast.ExprStmt():
                return self.check_expr(stmt_ast.expr, e, None) == typs.NEVER
            case ast.RetStmt():
    ...
    def check_ret_stmt(self, ret_ast: ast.RetStmt, e: ir_env.Env) -> None:
    ...
    def check_let_stmt(self, let_ast: ast.LetStmt, e: ir_env.Env) -> bool:
    ...
    def check_assignment_stmt(self, ass_ast: ast.AssignmentStmt, e: ir_env.Env) -> bool:
